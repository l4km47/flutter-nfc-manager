...
struct PigeonNdef {
  ...
  static func fromList(_ list: [Any?]) -> PigeonNdef? {
    ...
    let capacity: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    var cachedNdefMessage: PigeonNdefMessage? = nil
...
struct PigeonISO15693 {
  ...
  static func fromList(_ list: [Any?]) -> PigeonISO15693? {
    let icManufacturerCode: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
...
struct PigeonFeliCaReadWithoutEncryptionResponse {
  ...
  static func fromList(_ list: [Any?]) -> PigeonFeliCaReadWithoutEncryptionResponse? {
    let statusFlag1: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
    let statusFlag2: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
...
struct PigeonFeliCaRequestServiceV2Response {
  ...
  static func fromList(_ list: [Any?]) -> PigeonFeliCaRequestServiceV2Response? {
    let statusFlag1: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
    let statusFlag2: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    let encryptionIdentifier: Int64? = isNullish(list[2]) ? nil : (list[2] is Int64? ? list[2] as! Int64? : Int64(list[2] as! Int32))
...
struct PigeonISO7816APDU {
  ...
  static func fromList(_ list: [Any?]) -> PigeonISO7816APDU? {
    let instructionClass: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
    let instructionCode: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    let p1Parameter: Int64? = isNullish(list[2]) ? nil : (list[2] is Int64? ? list[2] as! Int64? : Int64(list[2] as! Int32))
    let p2Parameter: Int64? = isNullish(list[3]) ? nil : (list[3] is Int64? ? list[3] as! Int64? : Int64(list[3] as! Int32))
    let data: FlutterStandardTypedData? = nilOrValue(list[4])
    let expectedResponseLength: Int64? = isNullish(list[5]) ? nil : (list[5] is Int64? ? list[5] as! Int64? : Int64(list[5] as! Int32))
...
struct PigeonISO7816ResponseAPDU {
  ...
  static func fromList(_ list: [Any?]) -> PigeonISO7816ResponseAPDU? {
    ...
    let statusWord1: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    let statusWord2: Int64? = isNullish(list[2]) ? nil : (list[2] is Int64? ? list[2] as! Int64? : Int64(list[2] as! Int32))
...
struct PigeonISO15693SystemInfo {
  ...
  static func fromList(_ list: [Any?]) -> PigeonISO15693SystemInfo? {
    let dataStorageFormatIdentifier: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
    let applicationFamilyIdentifier: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    let blockSize: Int64? = isNullish(list[2]) ? nil : (list[2] is Int64? ? list[2] as! Int64? : Int64(list[2] as! Int32))
    let totalBlocks: Int64? = isNullish(list[3]) ? nil : (list[3] is Int64? ? list[3] as! Int64? : Int64(list[3] as! Int32))
    let icReference: Int64? = isNullish(list[4]) ? nil : (list[4] is Int64? ? list[4] as! Int64? : Int64(list[4] as! Int32))
...
struct PigeonNfcReaderSessionError {
  var code: PigeonNfcReaderErrorCode? = nil
  var message: String? = nil

  static func fromList(_ list: [Any?]) -> PigeonNfcReaderSessionError? {
    var code: PigeonNfcReaderErrorCode? = nil
    let codeEnumVal: Int? = nilOrValue(list[0])
    if let codeRawValue = codeEnumVal {
      code = PigeonNfcReaderErrorCode(rawValue: codeRawValue)!
    }
...
struct PigeonNfcVasCommandConfiguration {
  var mode: PigeonNfcVasCommandConfigurationMode? = nil
  var passIdentifier: String? = nil
  var url: String? = nil

  static func fromList(_ list: [Any?]) -> PigeonNfcVasCommandConfiguration? {
    var mode: PigeonNfcVasCommandConfigurationMode? = nil
    let modeEnumVal: Int? = nilOrValue(list[0])
    if let modeRawValue = modeEnumVal {
      mode = PigeonNfcVasCommandConfigurationMode(rawValue: modeRawValue)!
    }
    let passIdentifier: String? = nilOrValue(list[1])
...
struct PigeonNfcVasResponse {
  var status: PigeonNfcVasResponseErrorCode? = nil
  var vasData: FlutterStandardTypedData? = nil
  var mobileToken: FlutterStandardTypedData? = nil

  static func fromList(_ list: [Any?]) -> PigeonNfcVasResponse? {
    var status: PigeonNfcVasResponseErrorCode? = nil
    let statusEnumVal: Int? = nilOrValue(list[0])
    if let statusRawValue = statusEnumVal {
      status = PigeonNfcVasResponseErrorCode(rawValue: statusRawValue)!
    }
    let vasData: FlutterStandardTypedData? = nilOrValue(list[1])
    let mobileToken: FlutterStandardTypedData? = nilOrValue(list[2])
...
class PigeonFlutterApi {
  ...
  func tagReaderSessionDidBecomeActive(completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.tagReaderSessionDidBecomeActive", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { _ in
      completion()
    }
  }
  func tagReaderSessionDidDetect(tag tagArg: PigeonTag, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.tagReaderSessionDidDetect", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([tagArg] as [Any?]) { _ in
      completion()
    }
  }
  func tagReaderSessionDidInvalidateWithError(error errorArg: PigeonNfcReaderSessionError, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.tagReaderSessionDidInvalidateWithError", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([errorArg] as [Any?]) { _ in
      completion()
    }
  }
  func vasReaderSessionDidBecomeActive(completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.vasReaderSessionDidBecomeActive", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { _ in
      completion()
    }
  }
  func vasReaderSessionDidReceive(responses responsesArg: [PigeonNfcVasResponse], completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.vasReaderSessionDidReceive", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([responsesArg] as [Any?]) { _ in
      completion()
    }
  }
  func vasReaderSessionDidInvalidateWithError(error errorArg: PigeonNfcReaderSessionError, completion: @escaping () -> Void) {
    let channel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.nfc_manager.PigeonFlutterApi.vasReaderSessionDidInvalidateWithError", binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([errorArg] as [Any?]) { _ in
      completion()
    }
  }
