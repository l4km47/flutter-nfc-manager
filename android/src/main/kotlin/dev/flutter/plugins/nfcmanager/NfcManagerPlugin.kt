...
private fun toShort(value: PigeonTypeNameFormat): Short {
  return when (value) {
    ...
    PigeonTypeNameFormat.MIMEMEDIA -> NdefRecord.TNF_MIME_MEDIA
    PigeonTypeNameFormat.ABSOLUTEURI -> NdefRecord.TNF_ABSOLUTE_URI
    PigeonTypeNameFormat.EXTERNALTYPE -> NdefRecord.TNF_EXTERNAL_TYPE
...
private fun toPigeonTypeNameFormat(value: Short): PigeonTypeNameFormat {
  return when (value) {
    ...
    NdefRecord.TNF_MIME_MEDIA -> PigeonTypeNameFormat.MIMEMEDIA
    NdefRecord.TNF_ABSOLUTE_URI -> PigeonTypeNameFormat.ABSOLUTEURI
    NdefRecord.TNF_EXTERNAL_TYPE -> PigeonTypeNameFormat.EXTERNALTYPE
